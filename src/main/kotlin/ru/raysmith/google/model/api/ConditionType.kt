...
/** The type of condition. */
fun BooleanCondition.setType(errorType: ConditionType) = setType(errorType.name)

/** The type of condition. */
var BooleanCondition.typeE: ConditionType?
    get() = type?.let { ConditionType.valueOf(it) }
